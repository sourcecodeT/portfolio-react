...
function About(props) {
      ...
      <main className={'About'}>
        <section className="about_intro_section">
          ...
          <p className="about_p">
            ...
            {renderAnimatedLink({ href: "https://freecodecamp.org", type: "code", content: "freecodecamp.org" })}
            . There, I taught myself the basics of HTML, CSS and JavaScript.
            I also created some of my first projects: A
            {renderAnimatedLink({ href: "https://pokedex-dlv.firebaseapp.com/", type: "poke", content: "Pokedex" })}
            and the
            {renderAnimatedLink({ href: "https://game-of-life-dlv.firebaseapp.com/", type: "gol", content: "Game of life." })}
            They weren't perfect, but they were fun to make.
            It definitely set the path to pursuing a career in software development!
          </p>
          <span className="about_br_span about_span">{"</p> <p>"}</span>
          <p className="about_p">
            Later that same year, I attended
            {renderAnimatedLink({ href: "", type: "dev", content: "DevMountain" })}
            , an intense 13 week coding bootcamp.
            While there, I started learning fullstack web development,
            specifically with ReactJS.
            I spent 900+ hours learning new technologies and developing personal projects.
          </p>
          <span className="about_br_span about_span">{"</p> <p>"}</span>
          <p className="about_p">
            After graduating from the bootcamp and receiving my Javascript Web Development
            {renderAnimatedLink({
            ...
            {renderAnimatedLink({ href: "https://vibix-web.firebaseapp.com/", type: "vibix", content: "Vibix" })}
            . We worked on developing shopify apps to automate users' daily time-consuming tasks.
            I was solely responsible to build the web presence of the company by utilizing the latest technology
            (ReactJS/Redux/Cloud Functions/Firebase).
          </p>
          <span className="about_br_span about_span">{"</p> <p>"}</span>
          <p className="about_p">
            I don't just code,
            music and fitness are also a big part of my life!
  ...
  function renderAnimatedLink({ href, type, content }) {
    return (
      <a
        onMouseEnter={() => enterLink(type)}
        onMouseLeave={() => leaveLink(type)}
        className={`about_link about_link_${type}`}
        href={href}
        target="_blank"
